# nvim-treesitter-queries-scfg

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-scfg/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-scfg/actions/workflows/validate.yml)

Neovim tree-sitter queries for **scfg**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-scfg",
...
- [ ] Changes are scoped to `scfg` — do not include files for other languages
